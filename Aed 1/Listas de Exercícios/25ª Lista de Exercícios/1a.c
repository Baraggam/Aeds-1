...
void cadastrarAniversario(Aniversario *aniversarios[max]);
...
void menu(Aniversario *aniversarios[]){
	int opcao;
...
void cadastrarAniversario(Aniversario *aniversarios[]){
	if (tam < max){
		printf("\nDigite o nome do aniversariante: ");
		aniversarios[tam] = malloc(sizeof(Aniversario));
...
void pesquisarAniversario(Aniversario *aniversarios[]){
	int mes = lerData("mes", "Digite o mes do aniversario para a listagem: ");
	escreverAniversario(aniversarios, mes);}

void escreverAniversario(Aniversario *aniversarios[], int mes){
